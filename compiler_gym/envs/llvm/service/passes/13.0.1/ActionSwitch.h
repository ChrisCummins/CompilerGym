#define HANDLE_ACTION(action, handlePass)                            \
  switch (action) {                                                  \
    ...
    case LlvmAction::ANNOTATION2METADATA:                            \
      handlePass(llvm::createAnnotation2MetadataLegacyPass());       \
      break;                                                         \
    case LlvmAction::ANNOTATION_REMARKS:                             \
      handlePass(llvm::createAnnotationRemarksLegacyPass());         \
      break;                                                         \
    ...
    case LlvmAction::SIMPLIFYCFG:                                    \
      ...
      break;                                                         \
    case LlvmAction::CG_PROFILE:                                     \
      handlePass(llvm::createCGProfileLegacyPass());                 \
      break;                                                         \
    ...
    case LlvmAction::CANON_FREEZE:                                   \
      handlePass(llvm::createCanonicalizeFreezeInLoopsPass());       \
      break;                                                         \
    ...
    case LlvmAction::CONSTMERGE:                                     \
      ...
      break;                                                         \
    case LlvmAction::CONSTRAINT_ELIMINATION:                         \
      handlePass(llvm::createConstraintEliminationPass());           \
      break;                                                         \
    ...
    case LlvmAction::DFA_JUMP_THREADING:                             \
      handlePass(llvm::createDFAJumpThreadingPass());                \
      break;                                                         \
    case LlvmAction::DFSAN:                                          \
      handlePass(llvm::createDataFlowSanitizerLegacyPassPass());     \
      break;                                                         \
    ...
    case LlvmAction::FIX_IRREDUCIBLE:                                \
      handlePass(llvm::createFixIrreduciblePass());                  \
      break;                                                         \
    ...
    case LlvmAction::INLINE:                                         \
      ...
      break;                                                         \
    case LlvmAction::FUNCTION_SPECIALIZATION:                        \
      handlePass(llvm::createFunctionSpecializationPass());          \
      break;                                                         \
    ...
    case LlvmAction::IROUTLINER:                                     \
      handlePass(llvm::createIROutlinerPass());                      \
      break;                                                         \
    ...
    case LlvmAction::LOOP_FLATTEN:                                   \
      handlePass(llvm::createLoopFlattenPass());                     \
      break;                                                         \
    ...
    case LlvmAction::LOWER_MATRIX_INTRINSICS_MINIMAL:                \
      handlePass(llvm::createLowerMatrixIntrinsicsMinimalPass());    \
      break;                                                         \
    ...
    case LlvmAction::NEWGVN:                                         \
      ...
      break;                                                         \
    case LlvmAction::OPENMP_OPT_CGSCC:                               \
      handlePass(llvm::createOpenMPOptCGSCCLegacyPass());            \
      break;                                                         \
    ...
    case LlvmAction::UNIFY_LOOP_EXITS:                               \
      handlePass(llvm::createUnifyLoopExitsPass());                  \
      break;                                                         \
    case LlvmAction::VECTOR_COMBINE:                                 \
      handlePass(llvm::createVectorCombinePass());                   \
      break;                                                         \
  }
