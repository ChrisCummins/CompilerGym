...
class action_descriptions(Enum):
    ...
    AssumeSimplify = "Assume Simplify"
    AttributorCgscc = "Deduce and propagate attributes (CGSCC pass)"
    ...
    CgProfile = "Call Graph Profile"
    CallsiteSplitting = "Call-site splitting"
    CalledValuePropagation = "Called Value Propagation"
    CanonicalizeAliases = "Canonicalize aliases"
    CanonFreeze = "Canonicalize Freeze Instructions in Loops"
    ...
    EeInstrument = "Instrument function entry/exit with calls to e.g. mcount()(pre inlining)"
    FixIrreducible = "Convert irreducible control-flow into natural loops"
    Flattencfg = "Flatten the CFG"
    Float2int = "Float to int"
    Inline = "Function Integration/Inlining"
    FunctionSpecialization = "Propagate constant arguments by specializing the function"
    ...
    LowerMatrixIntrinsicsMinimal = "Lower the matrix intrinsics (minimal)"
    ...
    OpenmpOptCgscc = "OpenMP specific optimizations"
    ...
    PostInlineEeInstrument = "Instrument function entry/exit with calls to e.g. mcount()(post inlining)"
    ...
    ScalarizeMaskedMemIntrin = "Scalarize unsupported masked memory intrinsics"
    Scalarizer = "Scalarize vector operations"
    SeparateConstOffsetFromGep = "Split GEPs to a variadic base and a constant offset for better CSE"
    Sink = "Code sinking"
    ...
    StripNonlinetableDebuginfo = "Strip all debug info except linetables"
